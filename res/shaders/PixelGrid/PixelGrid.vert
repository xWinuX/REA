...
void main() {
    ...
    gl_Position = cameraProperties.proj * cameraProperties.view * vec4(((POSITION[a_Index]*GRID_SIZE_VEC) + (gridInfo.offset * CHUNK_SIZE)) / cameraProperties.pixelsPerUnit, -100.0f, 1.0f);

    v_PixelPosition = UV[a_Index] * GRID_SIZE_VEC;
}